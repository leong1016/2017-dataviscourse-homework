...
class Table {
    ...
    createTable() {
        ...
        d3.selectAll("thead td").data(this.tableHeaders).on("click", (k, i) => {
            let invert;
            console.log(sortedTableHeaders)
            if (sortedTableHeaders[i] === true) {
                sortedTableHeaders[i] = false;
                invert = true;
            } else {
                sortedTableHeaders = this.tableHeaders.map(function () {
                    return false
                });
    ...
    updateTable() {
        ...
        let svgEnter = tdEnter.filter(function (d) {
            return d.vis !== 'text'
        })
            .append("svg");
        ...
        let gameColumns = svg.filter(function (d) {
            return d.vis === 'bars';
        });
        ...
        let roundColumnsEnter = td.filter(function (d) {
            return d.vis === 'text';
        });
        let roundColumns = td.filter(function (d) {
            return d.vis === 'text';
        });
        ...
        let goalColumnsEnter = svgEnter.filter(function (d) {
            return d.vis === 'goals';
        });
        let goalColumns = svg.filter(function (d) {
            return d.vis === 'goals';
        });
